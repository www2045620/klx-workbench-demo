    ...
    angular.module( 'treeControl', [] )
        ...
        .directive( 'treecontrol', ['$compile', function( $compile ) {
            ...
            return {
                ...
                controller: ['$scope', '$templateCache', '$interpolate', 'treeConfig','$timeout', function ($scope, $templateCache, $interpolate, treeConfig,$timeout) {
                    ...
                    $scope.selectNodeHead = function(n) {
...
//                    return "" + $scope.orderBy;
                    ...
                    if(!template) {
                        template =
                            ...
                            '<div class="tree-label {{options.labelClass}}" ng-class="[selectedClass(), unselectableClass()]" ng-dblclick="selectNodeHead(node)" ng-click="selectNodeLabel(node)" tree-transclude></div>' +
